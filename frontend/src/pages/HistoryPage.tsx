...
const HistoryPage: React.FC = () => {
  const { analysisHistory, clearHistory, removeHistoryItem } =
      ...
      <div className="max-w-4xl mx-auto text-center py-16">
        <div className="bg-white p-8 rounded-xl shadow-md">
          ...
          <p className="text-slate-600 mb-6">
            You haven't performed any fingerprint analyses yet. Go to the
            Analysis page to analyze a fingerprint.
          </p>
          <a
            href="/analysis"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        {/* <p className="text-xs text-slate-500">
                          Confidence: {item.typeConfidence}%
                        </p> */}
                      </div>
                      <div>
                        <div className="flex items-center mb-1">
                        ...
                        {/* <p className="text-xs text-slate-500">
                          Confidence: {item.bloodConfidence}%
                        </p> */}
                      </div>
                    </div>
                  </div>
