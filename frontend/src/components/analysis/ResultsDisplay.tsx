  ...
  if (isAnalyzing) {
    return (
      <div className="flex flex-col items-center justify-center p-8 h-64 bg-slate-50 rounded-lg border border-slate-200">
        ...
        <p className="mt-2 text-xs text-slate-500">Please wait while our neural networks process your image</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="sm:w-2/3 space-y-4">
          ...
          <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
            <div className="flex items-center mb-2">
              ...
              <h3 className="text-sm font-medium text-slate-700">Fingerprint Type</h3>
            </div>
            <div className="flex justify-between items-center">
              <p className="text-xl font-semibold text-slate-800">{analysisResults.fingerprintType}</p>
          ...
          <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
            <div className="flex items-center mb-2">
              ...
              <h3 className="text-sm font-medium text-slate-700">Blood Group</h3>
            </div>
            <div className="flex justify-between items-center">
              <p className="text-xl font-semibold text-slate-800">{analysisResults.bloodGroup}</p>
      ...
      <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
        <h3 className="text-sm font-medium text-slate-700 mb-3">Pattern Matching</h3>
      ...
      <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200 text-sm text-yellow-800">
        <p>
          ...
          Blood group prediction should be confirmed through medical testing.
        </p>
      </div>
    </div>
  );
